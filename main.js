...
/* harmony export */   "plusButtonImageLogic": () => (/* binding */ plusButtonImageLogic),
...
/* harmony export */   "updateAfterRemove": () => (/* binding */ updateAfterRemove)
/* harmony export */ });
...
function updateAfterRemove(remove) {
...
let todocatch1 = []
function createTodo(title, description, duedate, priority, note, project, completed = false) 
{   
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "project-todolist:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkproject_todolist"] = self["webpackChunkproject_todolist"] || [];
...
/* harmony import */ var _projectmaker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectmaker.js */ "./src/projectmaker.js");
/* harmony import */ var _todomodule_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todomodule.js */ "./src/todomodule.js");
/* harmony import */ var _domLogic_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domLogic.js */ "./src/domLogic.js");
/* harmony import */ var _buttonlogic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./buttonlogic.js */ "./src/buttonlogic.js");
...
(0,_buttonlogic_js__WEBPACK_IMPORTED_MODULE_3__.addButtonLogic)();

// run dom logic

(async function dom() {
    let dom = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./domLogic.js */ "./src/domLogic.js"))
...
const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(2014, 1, 11), 'yyyy-MM-dd')
console.log(date)
