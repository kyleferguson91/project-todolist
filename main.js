...
buttons.forEach((elem,ind,arr) => {
    elem.addEventListener('click', (e) => {
        ...
        console.log(_projectmaker_js__WEBPACK_IMPORTED_MODULE_1__.defaultprojects[e.target.id])
    })
})
