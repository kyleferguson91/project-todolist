...
function todoMaker(title, description, duedate, priority, note, project, completed = false) 
{
...
const obj1 = _todomodule_js__WEBPACK_IMPORTED_MODULE_0__.todoMaker('fresh')

console.log(obj1)

// project stuff

console.log(_projectmaker_js__WEBPACK_IMPORTED_MODULE_1__.customprojects)
