...
Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_acorn_dist_acorn_mjs"), __webpack_require__.e("src_domLogic_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./domLogic.js */ "./src/domLogic.js"))
.then((obj) => {
    obj.render()
})
...
const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(2014, 1, 11), 'yyyy-MM-dd')
console.log(date)
