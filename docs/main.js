...
const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'EEEE, LLLL dd, yyyy')
console.log(date)
console.log((0,_localstorage_js__WEBPACK_IMPORTED_MODULE_0__.storageAvailable)('localStorage'))



// check if storage exists, in this case localstorage

if ((0,_localstorage_js__WEBPACK_IMPORTED_MODULE_0__.storageAvailable)('localStorage')) {
...
localStorage.setItem('projects', JSON.stringify({}))
        ...
        console.log(_projectmaker_js__WEBPACK_IMPORTED_MODULE_1__.projects, )
...
//localStorage.clear()
        for (let prop in JSON.parse(localStorage.getItem('projects'))) {
            ...
            _projectmaker_js__WEBPACK_IMPORTED_MODULE_1__.projects[prop] = JSON.parse(localStorage.getItem('projects'))[prop]
...
Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_date-fns_esm_parseISO_index_js-node_modules_punycode_punycode_es6_js"), __webpack_require__.e("src_buttonlogic_js-src_domLogic_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./domLogic.js */ "./src/domLogic.js"))
.then((obj) => {
    obj.render()
